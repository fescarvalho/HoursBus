...
import { NatividadeVarreSai } from "./../../hours-mock-natividade.json";

const CardNatVarre = ({ titleTo, titleFrom }: CardProps) => {
      ...
      <div className={`${show === true ? styles.cardMainActive : styles.cardMain}`}>
        ...
        <div className={`${show == true ? styles.cardContent : styles.cardContentFalse}`}>
          <ul className={styles.list}>
            <h2>TODOS OS DIAS</h2>
            {NatividadeVarreSai.horas.map((item) => (
